    ...
    if (user && appPassword) {
      try {
        ...
        await transporter.sendMail({
          ...
          text: `${sender.username} vous a envoyé un message sur DB Non-Off 90's. Connectez-vous pour le lire et y répondre : ${process.env.NEXT_PUBLIC_SITE_URL || "https://db90.org"}/compte/messages/${sender.username}`,
        });
      } catch (mailError) {
